 ...
 */
class MUFlash_Api_Base_Mailz extends Zikula_AbstractApi
{
    /**
    ...
    public function getPlugins($args)
    {
        ...
        $plugins[] = array(
            'pluginid'      => 1,
            'module'        => 'MUFlash',
            'title'         => $this->__('3 newest movies'),
            'description'   => $this->__('A list of the three newest movies.')
        );
        $plugins[] = array(
            'pluginid'      => 2,
            'module'        => 'MUFlash',
            'title'         => $this->__('3 random movies'),
            'description'   => $this->__('A list of three random movies.')
        );
        return $plugins;
    }
