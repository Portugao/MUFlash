 ...
 */
class MUFlash_Controller_Base_User extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
...
// DEBUG: permission check aspect ends
    ...
    {
// DEBUG: permission check aspect starts
        $this->throwForbiddenUnless(SecurityUtil::checkPermission('MUFlash::', '::', ACCESS_READ));
// DEBUG: permission check aspect ends
        ...
        if ($tpl == 'tree') {
            ...
            return MUFlash_Util_View::processTemplate($this->view, 'user', $objectType, 'view', $args);
        }
...
// DEBUG: permission check aspect ends
        ...
        // fetch and return the appropriate template
        return MUFlash_Util_View::processTemplate($this->view, 'user', $objectType, 'display', $args);
    }
}
