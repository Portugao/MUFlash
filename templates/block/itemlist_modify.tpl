...
<div class="z-formrow">
    <label for="MUFlash_sorting">{gt text='Sorting'}:</label>
    <select id="MUFlash_sorting" name="sorting">
...
<div class="z-formrow">
    <label for="MUFlash_amount">{gt text='Amount'}:</label>
    <input type="text" id="MUFlash_amount" name="amount" size="10" value="{$amount|default:"5"}" />
</div>
...
<div class="z-formrow">
    <label for="MUFlash_filter">{gt text='Filter (expert option)'}:</label>
    <input type="text" id="MUFlash_filter" name="filter" size="40" value="{$filterValue|default:""}" />
