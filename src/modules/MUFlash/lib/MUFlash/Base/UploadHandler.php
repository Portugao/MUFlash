 ...
 */
class MUFlash_Base_UploadHandler
{
    /**
    ...
    {
        $this->allowedObjectTypes = array('movie');
    ...
    public function performFileUpload($objectType, $fileData, $fieldName)
    {
        ...
        // retrieve the final file name
        $basePath = MUFlash_Util_Controller::getFileBaseFolder($objectType, $fieldName);
