 ...
 */
class MUFlash_Form_Handler_Admin_Movie_Base_Edit extends MUFlash_Form_Handler_Admin_Edit
{
    /**
    ...
    public function preInitialize()
    {
        ...
        $this->objectTypeLowerMultiple = 'movies';

        $this->hasPageLockSupport = true;
        // array with upload fields and mandatory flags
        $this->uploadFields = array('preview' => false, 'flashFile' => false);
    }
    ...
    protected function getDefaultReturnUrl($args, $obj)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            // redirect to the detail page of treated movie
            $url = ModUtil::url($this->name, 'admin', 'display', array('ot' => 'movie', 'id' => $this->idValues['id']));
        }
        return $url;
    }
