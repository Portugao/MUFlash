 ...
 */
class MUFlash_Api_Base_User extends Zikula_AbstractApi
{
    /**
    ...
    public function encodeurl($args)
    {
        ...
        $routerFacade = new MUFlash_RouterFacade();
        ...
        $allowedObjectTypes = MUFlash_Util_Controller::getObjectTypes('api', $utilArgs);
        $objectType = ((isset($args['args']['ot']) && in_array($args['args']['ot'], $allowedObjectTypes)) ? $args['args']['ot'] : MUFlash_Util_Controller::getDefaultObjectType('api', $utilArgs));
        ...
        $modInfo = ModUtil::getInfoFromName('MUFlash');
