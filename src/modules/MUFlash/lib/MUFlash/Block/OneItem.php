 ...
 */
class MUFlash_Block_OneItem extends Zikula_Controller_AbstractBlock
{
    /**
    ...
    {
        SecurityUtil::registerPermissionSchema('MUFlash:OneItemBlock:', 'Block title::');
    }
    ...
    public function info()
    {
        ...
        return array('module'           => 'MUFlash',
                     ...
                     'text_type_long'   => $this->__('Show one item of MUFlash by id.'),
                     'allow_multiple'   => true,
                     'form_content'     => false,
                     'form_refresh'     => false,
                     'show_preview'     => true,
    ...
    public function display($blockinfo)
    {
        ...
        if (!SecurityUtil::checkPermission('MUFlash:OneItemBlock:', "$blockinfo[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
      ...
      //  $this->view->setCaching(true);
        ...
        if ($vars['showtitle'] == 1) {
            ...
            if (empty($blockinfo['title'])) {
                $blockinfo['title'] = $this->__('One MUFlash Item');
            }
        }
