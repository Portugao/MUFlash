 ...
 */
class MUFlash_Controller_Base_Admin extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
...
// DEBUG: permission check aspect ends
        ...
        if ($tpl == 'tree') {
            ...
            return MUFlash_Util_View::processTemplate($this->view, 'admin', $objectType, 'view', $args);
        }
...
// DEBUG: permission check aspect ends
        ...
        // fetch and return the appropriate template
        return MUFlash_Util_View::processTemplate($this->view, 'admin', $objectType, 'display', $args);
    }
...
// DEBUG: permission check aspect ends
        ...
        $handlerClass = 'MUFlash_Form_Handler_Admin_' . ucfirst($objectType) . '_Edit';
