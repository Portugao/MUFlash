...
/**
 * The muflashActionUrl modifier creates the URL for a given action.
 *
 ...
 */
function smarty_modifier_muflashActionUrl($urlType, $urlFunc, $urlArguments)
{
    return DataUtil::formatForDisplay(ModUtil::url('MUFlash', $urlType, $urlFunc, $urlArguments));
}
