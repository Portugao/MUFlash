...
/**
 * The muflashImageThumb modifier displays a thumbnail image.
 *
 ...
 */
function smarty_modifier_muflashImageThumb($fileName = '', $filePath = '', $width = 100, $height = 80, $thumbArgs = array())
{
    /**
     ...
     */
    return MUFlash_Util_Image::getThumb($filePath, $width, $height, $thumbArgs);
}
